...
export const initialItems: Item[] = [
  {
    id: '1',
    sku: 'SKU-001',
    name: 'Date Crown Khalas (1 Kg) x 10 box',
    category: 'Kurma',
    unit: 'Dus',
    description: 'Kurma premium kualitas terbaik.',
    tiers: [
      { min: 1, max: 5, price: 550000 },
      { min: 6, max: 24, price: 545000 },
      { min: 25, max: 49, price: 535000 },
      { min: 50, max: 999999, price: 525000 }
    ]
  },
  {
    id: '2',
    sku: 'SKU-002',
    name: 'Date Crown Khalas (250g) x 40 pcs',
    category: 'Kurma',
    unit: 'Dus',
    description: 'Kemasan ekonomis thermo pack.',
    tiers: [
      { min: 1, max: 5, price: 425000 },
      { min: 6, max: 24, price: 410000 },
      { min: 25, max: 999999, price: 400000 }
    ]
  },
  {
    id: '3',
    sku: 'SKU-003',
    name: 'Sirup Karamel 1L SRA',
    category: 'Bahan Tambahan',
    unit: 'Btl',
    description: 'Sirup karamel untuk campuran minuman kopi dan dessert.',
    tiers: [
      { min: 1, max: 5, price: 80000 },
      { min: 6, max: 20, price: 75000 },
      { min: 21, max: 999999, price: 70000 }
    ]
  }
];
...
export const initialCustomers: Customer[] = [
  {
    ...
    creditNotes: 'Plafon kredit tempo Net 14 Hari sesuai kesepakatan sales'
  },
  {
    id: 'CUST-002',
    ...
    attnName: 'Ibu Ratna',
    email: 'purchasing@berkahretail.com',
    phone: '089876543210',
    address: 'Jl. Puri Indah Raya Blok A, Jakarta Barat',
    npwp: '02.345.678.9-123.000',
    creditLimit: 50000000,
    warningThresholdPct: 10,
    creditNotes: 'Plafon kredit tempo Net 30 Hari'
  }
];
...
export const initialQuotations: Quotation[] = [
  {
    id: 'QUO-202608-101',
    issuingCompany: 'PT Sumber Roso Agromakmur',
    companyNpwp: '01.234.567.8-123.000',
    companyAddress: 'Jl. Raya Bekasi Timur No. 136, Cipinang Besar Utara, Jatinegara, Jakarta 13410',
    bankDetails: 'BCA No. 4967 959 595 a.n. PT Sumber Roso Agromakmur',
    createdBy: 'sales',
    salesName: 'Siti Rahma (Sales)',
    createdByRole: 'sales',
    date: '2026-08-10',
    status: 'SO_Confirmed',
    isSO: true,
    soNumber: 'SO-202608-27795',
    soDate: '2026-08-10',
    orderDate: '2026-08-10',
    dueDate: '2026-08-24',
    paymentTerm: 'Net 14 Hari',
    paymentStatus: 'UNPAID',
    customerName: 'PT Maju Bersama Sukses',
    storeName: 'Superindo Tebet',
    attnName: 'Bp. Hendra',
    customerEmail: 'procurement@majubersama.co.id',
    customerAddress: 'Jl. Sudirman Kav 21, Jakarta Selatan',
    customerNpwp: '01.234.567.8-012.000',
    items: [
      { itemId: '1', qty: 20, unitPrice: 280000, subtotal: 5600000, itemDiscount: 0, itemDiscountType: 'nominal' },
      { itemId: '2', qty: 15, unitPrice: 480000, subtotal: 7200000, itemDiscount: 0, itemDiscountType: 'nominal' }
    ],
    subtotal: 12800000,
    ...
    taxValue: 1408000,
    total: 14208000,
    notes: 'Mohon barang dikirim ke Gudang Superindo Tebet.',
    isApprovedByManager: true,
    managerApprovedBy: 'Andi Triyanto (Manager)'
  },
  {
    id: 'QUO-202608-102',
    issuingCompany: 'PT Exindokarsa Agung',
    companyNpwp: '02.345.678.9-234.000',
    companyAddress: 'Jl. Raya Bekasi Timur No. 136, Jakarta 13410',
    bankDetails: 'BCA No. 4960 496 022 a.n. PT Exindokarsa Agung',
    createdBy: 'budi',
    ...
    status: 'SO_Confirmed',
    isSO: true,
    soNumber: 'SO-202608-18920',
    soDate: '2026-08-08',
    orderDate: '2026-08-08',
    dueDate: '2026-08-22',
    paymentTerm: 'Net 14 Hari',
    paymentStatus: 'UNPAID',
    customerName: 'PT Berkah Retail Nusantara',
    storeName: 'Hypermart Puri Indah',
    attnName: 'Ibu Ratna',
    customerEmail: 'purchasing@berkahretail.com',
    customerAddress: 'Jl. Puri Indah Raya Blok A, Jakarta Barat',
    customerNpwp: '02.345.678.9-123.000',
    items: [
      { itemId: '3', qty: 25, unitPrice: 320000, subtotal: 8000000, itemDiscount: 0, itemDiscountType: 'nominal' },
      { itemId: '4', qty: 10, unitPrice: 650000, subtotal: 6500000, itemDiscount: 0, itemDiscountType: 'nominal' }
    ],
    subtotal: 14500000,
    discountType: 'nominal',
    discountInput: 0,
    ...
    taxValue: 1595000,
    total: 16095000,
    notes: 'Pengiriman bertahap ke Store Hypermart Puri Indah.',
    isApprovedByManager: true,
    managerApprovedBy: 'Andi Triyanto (Manager)'
  },
  {
    ...
    bankDetails: 'BCA No. 4967 959 595 a.n. PT Sumber Roso Agromakmur',
    createdBy: 'hendra',
    salesName: 'Hendra Pratama (Sales)',
    createdByRole: 'sales',
    date: '2026-08-12',
    ...
    customerName: 'PT Maju Bersama Sukses',
    storeName: 'Superindo Duren Sawit',
    attnName: 'Bp. Hendra',
    customerEmail: 'procurement@majubersama.co.id',
    customerAddress: 'Jl. Sudirman Kav 21, Jakarta Selatan',
    customerNpwp: '01.234.567.8-012.000',
    items: [
      { itemId: '1', qty: 10, unitPrice: 280000, subtotal: 2800000, itemDiscount: 0, itemDiscountType: 'nominal' },
      { itemId: '5', qty: 20, unitPrice: 190000, subtotal: 3800000, itemDiscount: 0, itemDiscountType: 'nominal' }
    ],
    subtotal: 6600000,
    discountType: 'nominal',
    discountInput: 0,
    ...
    taxValue: 726000,
    total: 7326000,
    notes: 'Penawaran promo kurma & kismis untuk Superindo Duren Sawit.'
  }
];
